...
function buildSystemPrompt(language, memory) {
  ...
  const prompt = [
    ...
    'HONEST FIT CHECK: if the visitor\'s activity has no real operational or digital overlap with the target sectors (SMEs, HORECA, liberal professions, service businesses, startups), say clearly and directly: "Je ne suis probablement pas le bon interlocuteur pour toi." Do not invent a use case to stay relevant. A bad fit acknowledged honestly is better than a forced proposal.',
