...
const BOT_COPY = {
  fr: {
    welcome: 'Bonjour. Je suis l\'assistant de Serafino Résout. Je peux t\'aider à comprendre si l\'offre d\'Enrico correspond à ta situation — de façon claire et concrète. Commence par me parler de ton activité ou pose une question directe.',
  ...
  en: {
    welcome: 'Hello. I\'m the Serafino Résout assistant. I can help you understand whether Enrico\'s offer fits your situation — clearly and concretely. Tell me about your activity or ask a direct question.',
  ...
  it: {
    welcome: 'Ciao. Sono l\'assistente di Serafino Résout. Posso aiutarti a capire se l\'offerta di Enrico fa al caso tuo — in modo chiaro e concreto. Raccontami della tua attività o fai una domanda diretta.',
  ...
  'de-CH': {
    welcome: 'Hallo. Ich bin der Assistent von Serafino Résout. Ich kann dir helfen zu verstehen, ob Enricos Angebot zu deiner Situation passt — klar und konkret. Erzähl mir von deiner Tätigkeit oder stelle eine direkte Frage.',
